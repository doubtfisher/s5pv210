...
struct gpio_switch_platform_data headset_switch_data ={
	.name="GPH1",
	.gpio=S5PV210_GPH1(0), //GPIOH1_0 detect earphone insert action.
	.state_on="1",
	.state_off="0",	
};
...
static int smdkv210_power_en(void)
{
	...
	/* enable camera power */
	s3c_gpio_setpull(S5PV210_GPF3(4), S3C_GPIO_PULL_UP);
	s3c_gpio_cfgpin(S5PV210_GPF3(4), S3C_GPIO_SFN(1));
	gpio_set_value(S5PV210_GPF3(4), 0);
...
MACHINE_START(SMDKC110, "SMDKV110")
